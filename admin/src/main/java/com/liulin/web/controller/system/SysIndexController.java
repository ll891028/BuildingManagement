...
import com.liulin.common.core.domain.entity.SysMenu;
import com.liulin.common.core.domain.entity.SysUser;
import com.liulin.common.core.text.Convert;
import com.liulin.common.utils.CookieUtils;
...
public class SysIndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", LiulinConfig.getCopyrightYear());
        mmap.put("demoEnabled", LiulinConfig.isDemoEnabled());
    ...
    {
        mmap.put("version", LiulinConfig.getVersion());
        return "main";
    }
