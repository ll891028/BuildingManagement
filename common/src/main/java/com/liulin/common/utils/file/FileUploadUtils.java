...
import com.liulin.common.exception.file.FileSizeLimitExceededException;
import com.liulin.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = LiulinConfig.getProfile();
    ...
    {
        int dirLastIndex = LiulinConfig.getProfile().length() + 1;
