...
import com.liulin.system.domain.SysConfig;
import com.liulin.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService
{
    ...
    public void deleteConfigByIds(String ids) throws Exception {
        ...
        for (Long configId : configIds)
        {
            ...
            {
                throw new Exception(String.format("内置参数【%1$s】不能删除 ", config.getConfigKey()));
            }
